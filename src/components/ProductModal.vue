          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="tempProduct.imagesUrl" id="image" placeholder="請輸入圖片連結">
              </div>
              <div class="mb-3">
              ...
              <div class="mt-5">
                <div class="mb-3 input-group">
                  <input v-model="tempProduct.link" type="url" class="form-control form-control" placeholder="請輸入連結">
...
export default {
  ...
  methods: {
    ...
    uploadFile () {
      ...
      formData.append('file-to-upliad', uploadedFile)
